...
# GoPro paired real-blur evaluation example:
# dataset=gopro
# eval_split=test
# problem=denoising
# python main.py --opts dataset ${dataset} eval_split ${eval_split} model ${model} problem ${problem} method pnp_flow max_batch ${max_batch} batch_size_ip ${batch_size_ip}
